  ...
  switch (template) {
    case EmailTemplate.EmailVerification:
      return {
        ...
        body: render(<EmailVerificationTemplate {...(props as PropsMap[EmailTemplate.EmailVerification])} />),
      };
    case EmailTemplate.PasswordReset:
      return {
        subject: 'Reset your password',
        body: render(<ResetPasswordTemplate {...(props as PropsMap[EmailTemplate.PasswordReset])} />),
      };
    default:
